...
# 🦁 XXD Panel 076｜أقلام شمعية بألوان الماكارون

### يحوّل الصورة إلى ذكرى سفر إنسانية بقلم شمعي داكن خشن وألوان ماكرون مشرقة
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 076 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تُبقي كثير من معالجات الرسم معلومات الخلفية كثيفة، أو تفرض ألوان حلوى رخيصة باسم الراحة. فتفقد دقة العنصر والتنفس المكاني معًا.

يعيد **Panel 076** اكتشاف العنصر بخطوط خشنة من القلم الشمعي الداكن والفحم والقلم الملون. يمكن للخط أن ينقطع ويتكرر وينزاح ويُفرك، مع بقاء النسب والاتجاه والوضع الأساسية دقيقة. يحذف الخلفية عمدًا ويترك نحو 45٪ أو أكثر من الفراغ الشرقي المتصل، ثم يعيد ضبط أدفأ إشارات الأصل وأكثرها حيوية إلى مساحات ماكرون مشرقة وصافية بلا حلاوة زائدة.

### مناسب لـ

- منح صور السفر والحياة دفئًا إنسانيًا مستمدًا من الشمس والملابس والزهور والجدران؛
- الحذف الجريء مع حفظ الهوية والعدد والنسب والاتجاه والبنية والوضع؛
- ألوان ماكرون صافية ومشرقة بلا ظلمة موحلة أو حلوى رخيصة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 076 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** قلم شمعي داكن خشن · فحم وقلم ملون · مساحات ماكرون مشرقة · فراغ متصل 45٪ · ورق طبيعي · ملاحظات آلة كاتبة
...
|---|---|
| **الناتج** | ملصق إنساني دافئ وحيوي وأخرق قليلًا، تحكمه بنية نشر ناضجة |
| **البصمة الواضحة** | قلم شمعي داكن خشن ومساحات ماكرون مطفأة قليلة ونحو 45٪ أو أكثر من الفراغ المتصل |
| **احترام المصدر** | يحفظ قسم الصورة الهوية والحقائق المكانية، ويحذف قسم التحويل كثافة الخلفية مع تثبيت البنية الأساسية |
...
```text
تثبيت الهوية والعدد والنسب والحركة → حذف كثافة الخلفية الزائدة → إعادة اكتشاف الشكل بخطوط القلم والفحم والقلم الملون → شبكة ضمنية وتوازن غير متماثل → فراغ متصل 45٪ أو أكثر → إعادة ضبط ألوان الأصل الدافئة إلى ماكرون → ملاحظات آلة كاتبة
```

## سمات النتيجة النهائية

- يمكن للمحيط أن ينقطع ويتكرر وينزاح ويرتجف، ويصنع التهشير والفرك والخط المتراكب وزنًا موضعيًا.
- يبقى سنّ الورق والاحتكاك الشمعي والانقطاعات الحبيبية والحواف الجافة والورق المكشوف ظاهرًا.
- يظهر الغواش أو الأكريليك بقدر قليل لا كطلاء سميك كامل، وتبقى ألوان الماكرون مشرقة بلا حلاوة زائدة.
- يتركز العنصر في منطقة واحدة ويعمل نحو 45٪ أو أكثر من الفراغ كسماء أو هواء أو مسافة أو ماء أو أرض.
- تتبع حروف الآلة الكاتبة الصغيرة الحركة وحافة الفراغ كملاحظة خاصة، لا كعنوان تقليدي.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-076-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 076. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-076 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-076 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-076 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-076 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-076 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 076 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-076 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-076`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-076-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-076-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ76 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 076 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–076) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
